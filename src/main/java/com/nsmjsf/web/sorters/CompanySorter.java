...
public class CompanySorter implements Comparator<Company>{
	private static final Log log = LogFactory.getLog(CompanySorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public CompanySorter(String sortField, SortOrder sortOrder) {
