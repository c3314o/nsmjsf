...
public class IndexTypeSorter implements Comparator<IndexType>{
	private static final Log log = LogFactory.getLog(IndexTypeSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public IndexTypeSorter(String sortField, SortOrder sortOrder) {
