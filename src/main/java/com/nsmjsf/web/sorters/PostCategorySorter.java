...
public class PostCategorySorter implements Comparator<PostCategory>{
	private static final Log log = LogFactory.getLog(PostCategorySorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public PostCategorySorter(String sortField, SortOrder sortOrder) {
