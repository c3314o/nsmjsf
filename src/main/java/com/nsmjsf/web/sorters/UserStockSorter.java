...
public class UserStockSorter implements Comparator<UserStock>{
	private static final Log log = LogFactory.getLog(UserStockSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public UserStockSorter(String sortField, SortOrder sortOrder) {
