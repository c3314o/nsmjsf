...
public class UserInfoSorter implements Comparator<UserInfo> {
	private static final Log log = LogFactory.getLog(UserInfoSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public UserInfoSorter(String sortField, SortOrder sortOrder) {
