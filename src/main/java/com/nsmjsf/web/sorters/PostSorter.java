...
public class PostSorter implements Comparator<Post>{
	private static final Log log = LogFactory.getLog(PostSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public PostSorter(String sortField, SortOrder sortOrder) {
