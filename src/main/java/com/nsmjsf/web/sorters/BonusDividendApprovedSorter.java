...
public class BonusDividendApprovedSorter implements Comparator<BonusDividendApproved>{
	private static final Log log = LogFactory.getLog(BonusDividendApprovedSorter.class);
