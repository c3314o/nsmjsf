...
public class FiscalYearSorter implements Comparator<FiscalYear>{
	private static final Log log = LogFactory.getLog(FiscalYearSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public FiscalYearSorter(String sortField, SortOrder sortOrder) {
