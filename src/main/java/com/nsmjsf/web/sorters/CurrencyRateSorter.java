...
public class CurrencyRateSorter implements Comparator<CurrencyRate>{
	private static final Log log = LogFactory.getLog(CurrencyRateSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public CurrencyRateSorter(String sortField, SortOrder sortOrder) {
