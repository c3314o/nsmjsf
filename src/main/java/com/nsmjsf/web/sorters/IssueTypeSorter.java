...
public class IssueTypeSorter implements Comparator<IssueType> {
	private static final Log log = LogFactory.getLog(IssueTypeSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public IssueTypeSorter(String sortField, SortOrder sortOrder) {
