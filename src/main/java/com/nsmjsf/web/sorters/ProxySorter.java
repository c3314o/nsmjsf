...
public class ProxySorter implements Comparator<Proxy> {
	private static final Log log = LogFactory.getLog(ProxySorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public ProxySorter(String sortField, SortOrder sortOrder) {
