...
public class ForumThreadSorter implements Comparator<ForumThread> {
	private static final Log log = LogFactory.getLog(ForumThreadSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public ForumThreadSorter(String sortField, SortOrder sortOrder) {
