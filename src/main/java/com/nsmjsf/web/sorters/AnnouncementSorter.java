...
public class AnnouncementSorter implements Comparator<Announcement> {
	private static final Log log = LogFactory.getLog(AnnouncementSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public AnnouncementSorter(String sortField, SortOrder sortOrder) {
