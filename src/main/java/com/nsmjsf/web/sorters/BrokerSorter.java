...
public class BrokerSorter implements Comparator<Broker>{
	private static final Log log = LogFactory.getLog(BrokerSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public BrokerSorter(String sortField, SortOrder sortOrder) {
