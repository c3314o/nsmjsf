...
public class MonthSorter implements Comparator<Month> {
	private static final Log log = LogFactory.getLog(MonthSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public MonthSorter(String sortField, SortOrder sortOrder) {
