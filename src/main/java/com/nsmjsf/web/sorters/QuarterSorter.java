...
public class QuarterSorter implements Comparator<Quarter> {
	private static final Log log = LogFactory.getLog(QuarterSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public QuarterSorter(String sortField, SortOrder sortOrder) {
