...
public class UserTypeSorter implements Comparator<UserType>{
	private static final Log log = LogFactory.getLog(UserTypeSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public UserTypeSorter(String sortField, SortOrder sortOrder) {
