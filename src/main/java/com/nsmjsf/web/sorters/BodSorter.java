...
public class BodSorter implements Comparator<Bod>{
	private static final Log log = LogFactory.getLog(BodSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public BodSorter(String sortField, SortOrder sortOrder) {
