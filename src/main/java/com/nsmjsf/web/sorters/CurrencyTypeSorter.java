...
public class CurrencyTypeSorter implements Comparator<CurrencyType> {
	private static final Log log = LogFactory.getLog(CurrencyTypeSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public CurrencyTypeSorter(String sortField, SortOrder sortOrder) {
