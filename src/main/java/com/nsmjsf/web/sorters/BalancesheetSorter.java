...
public class BalancesheetSorter implements Comparator<Balancesheet> {
	private static final Log log = LogFactory.getLog(BalancesheetSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public BalancesheetSorter(String sortField, SortOrder sortOrder) {
