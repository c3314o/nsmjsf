...
public class InterviewSorter implements Comparator<Interview> {
	private static final Log log = LogFactory.getLog(InterviewSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public InterviewSorter(String sortField, SortOrder sortOrder) {
