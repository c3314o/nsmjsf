...
public class AgmSorter implements Comparator<Agm>{
	private static final Log log = LogFactory.getLog(AgmSorter.class);
	
	 private String sortField;
     
	    private SortOrder sortOrder;
	     
	    public AgmSorter(String sortField, SortOrder sortOrder) {
	        this.sortField = sortField;
	        this.sortOrder = sortOrder;
	    }

	@Override
	public int compare(Agm o1, Agm o2) {
		 try {
