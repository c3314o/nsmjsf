...
public class PostImageSorter implements Comparator<PostImage> {
	private static final Log log = LogFactory.getLog(PostImageSorter.class);

	private String sortField;

	private SortOrder sortOrder;

	public PostImageSorter(String sortField, SortOrder sortOrder) {
