...
userTypeDataSource = new UserTypeDataSource();
		...
		userTypeWrapperList = UserTypeAdapter
				.wrapAll(userTypeList);
...
userInfoDataSource = new UserInfoDataSource();
		...
		userInfoWrapperList = UserInfoAdapter
				.wrapAll(userInfoList);
	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.user=userDataSource.get(editId);
			  ...
			  this.selectedUserTypeWrapper=UserTypeAdapter.wrap(user.getUserType());
	
			
			
			  
			  this.selectedUserInfoWrapper=UserInfoAdapter.wrap(user.getUserInfo());
...
public List<UserType> getUserTypeList() {
	...
	public void setUserTypeDataSource(
	...
	public void setUserTypeWrapperList(
			List<UserTypeWrapper> userTypeWrapperList) {
...
public List<UserInfo> getUserInfoList() {
	...
	public void setUserInfoDataSource(
	...
	public void setUserInfoWrapperList(
			List<UserInfoWrapper> userInfoWrapperList) {
