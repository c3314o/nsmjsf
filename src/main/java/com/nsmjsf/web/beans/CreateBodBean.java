...
bodTypeDataSource = new BodTypeDataSource();
		...
		bodTypeWrapperList = BodTypeAdapter
				.wrapAll(bodTypeList);
	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.bod=bodDataSource.get(editId);
			  ...
			  this.selectedFiscalYearWrapper=FiscalYearAdapter.wrap(bod.getFiscalYear());
...
public List<BodType> getBodTypeList() {
	...
	public void setBodTypeDataSource(
	...
	public void setBodTypeWrapperList(
			List<BodTypeWrapper> bodTypeWrapperList) {
	...
	public void setSelectedBodTypeWrapper(
			BodTypeWrapper selectedBodTypeWrapper) {
