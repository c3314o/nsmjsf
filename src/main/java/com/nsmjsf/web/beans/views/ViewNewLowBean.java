...
public class ViewNewLowBean implements Serializable {
	...
	public void setSelectedNewLowList(List<NewLow> selectedNewLowList) {
	...
	public void setFilteredNewLowList(List<NewLow> filteredNewLowList) {
	...
	public void newNewLow() {
		...
		RequestContext.getCurrentInstance().openDialog("createNewLow", options,
				null);
