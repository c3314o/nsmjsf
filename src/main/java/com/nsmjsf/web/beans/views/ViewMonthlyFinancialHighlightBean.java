...
private static final Log log = LogFactory.getLog(ViewMonthlyFinancialHighlightBean.class);
 ViewType viewType=ViewType.DATATABLE;
	...
	public ViewMonthlyFinancialHighlightBean()
	{
		...
		lazyModel=new LazyMonthlyFinancialHighlightDataModel(this.monthlyFinancialHighlightList);
	...
	public void refreshDataSource(){
		this.monthlyFinancialHighlightList=monthlyFinancialHighlightDataSource.getAll();
		lazyModel=new LazyMonthlyFinancialHighlightDataModel(this.monthlyFinancialHighlightList);
	...
	{
		monthlyFinancialHighlightList=monthlyFinancialHighlightDataSource.getAll();
	...
	public void setMonthlyFinancialHighlightList(List<MonthlyFinancialHighlight> monthlyFinancialHighlightList) {
	...
	public void setSelectedMonthlyFinancialHighlight(MonthlyFinancialHighlight selectedMonthlyFinancialHighlight) {
	...
	public void newMonthlyFinancialHighlight() {
		...
		RequestContext.getCurrentInstance().openDialog("createMonthlyFinancialHighlight",
				options, null);
	...
	public void onRowSelect(SelectEvent event) {
		System.out.println("MonthlyFinancialHighlight Selected"
				+ ((MonthlyFinancialHighlight) event.getObject()).getMonthlyFinancialHighlightId());
	...
	public void deleteMonthlyFinancialHighlight(MonthlyFinancialHighlight monthlyFinancialHighlight) {
			try{
			monthlyFinancialHighlightDataSource.delete(monthlyFinancialHighlight);
...
/*----------------------------------------*/
	...
	public void setEditMonthlyFinancialHighlightId(int editMonthlyFinancialHighlightId) {
