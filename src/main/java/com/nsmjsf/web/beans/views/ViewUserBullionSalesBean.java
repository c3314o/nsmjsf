...
private static final Log log = LogFactory.getLog(ViewUserBullionSalesBean.class);
 ViewType viewType=ViewType.DATATABLE;
	...
	public void setUserBullionSalesList(List<UserBullionSales> userBullionSalesList) {
	...
	public void setSelectedUserBullionSales(UserBullionSales selectedUserBullionSales) {
	...
	public void newUserBullionSales() {
		...
		RequestContext.getCurrentInstance().openDialog("createUserBullionSales",
				options, null);
	...
	public void onRowSelect(SelectEvent event) {
		System.out.println("UserBullionSales Selected"
				+ ((UserBullionSales) event.getObject()).getUserBullionSalesId());
