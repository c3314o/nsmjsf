...
private static final Log log = LogFactory.getLog(ViewBonusDividendApprovedBean.class);
 ViewType viewType=ViewType.DATATABLE;
	...
	public ViewBonusDividendApprovedBean()
	{
		...
		lazyModel=new LazyBonusDividendApprovedDataModel(this.bonusDividendApprovedList);
	...
	public void refreshDataSource(){
		this.bonusDividendApprovedList=bonusDividendApprovedDataSource.getAll();
		lazyModel=new LazyBonusDividendApprovedDataModel(this.bonusDividendApprovedList);
	...
	public void setBonusDividendApprovedList(List<BonusDividendApproved> bonusDividendApprovedList) {
	...
	public void setSelectedBonusDividendApproved(BonusDividendApproved selectedBonusDividendApproved) {
	...
	public void newBonusDividendApproved() {
		...
		RequestContext.getCurrentInstance().openDialog("createBonusDividendApproved",
				options, null);
	...
	public void onRowSelect(SelectEvent event) {
		System.out.println("BonusDividendApproved Selected"
				+ ((BonusDividendApproved) event.getObject()).getBonusDividendApprovedId());
	...
	public void deleteBonusDividendApproved(BonusDividendApproved bonusDividendApproved) {
			try{
