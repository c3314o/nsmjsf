...
public class ViewCertificateDividendDistributionBean implements Serializable {
	private static final Log log = LogFactory
			.getLog(ViewCertificateDividendDistributionBean.class);
	...
	public ViewCertificateDividendDistributionBean() {
		...
		lazyModel = new LazyCertificateDividendDistributionDataModel(
				this.certificateDividendDistributionList);
	...
	public void refreshDataSource() {
		this.certificateDividendDistributionList = certificateDividendDistributionDataSource
				.getAll();
		lazyModel = new LazyCertificateDividendDistributionDataModel(
				this.certificateDividendDistributionList);
	...
	private void populateData() {
		certificateDividendDistributionList = certificateDividendDistributionDataSource
				.getAll();
	...
	public void setCertificateDividendDistributionList(
			List<CertificateDividendDistribution> certificateDividendDistributionList) {
	...
	public void setSelectedCertificateDividendDistribution(
			CertificateDividendDistribution selectedCertificateDividendDistribution) {
	...
	public void newCertificateDividendDistribution() {
		...
		RequestContext.getCurrentInstance().openDialog(
				"createCertificateDividendDistribution", options, null);

	}

	public void onRowSelect(SelectEvent event) {
		System.out.println("CertificateDividendDistribution Selected"
				+ ((CertificateDividendDistribution) event.getObject())
	...
	public void deleteCertificateDividendDistribution(
			CertificateDividendDistribution certificateDividendDistribution) {
		try {
			certificateDividendDistributionDataSource
					.delete(certificateDividendDistribution);
	...
	public void setEditCertificateDividendDistributionId(
			int editCertificateDividendDistributionId) {
	...
	public void editCertificateDividendDistribution(int editId) {
		...
		RequestContext.getCurrentInstance().openDialog(
				"createCertificateDividendDistribution", options, params);
	}
