...
userWatchListDataSource = new UserWatchListDataSource();
	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.userWatchListStock=userWatchListStockDataSource.get(editId);
			  ...
			  this.selectedCompanyWrapper=CompanyAdapter.wrap(userWatchListStock.getCompany());
	
			
			
			  
			  this.selectedUserWatchListWrapper=UserWatchListAdapter.wrap(userWatchListStock.getUserWatchList());
	...
	public void setUserWatchListStockDataSource(UserWatchListStockDataSource userWatchListStockDataSource) {
...
public List<UserWatchList> getUserWatchListList() {
	...
	public UserWatchListStock saveUserWatchListStock() {
		try {
			...
			userWatchListStock.setCompany(company);
                  ...
                  UserWatchList userWatchList =selectedUserWatchListWrapper.getUserWatchList();
		...
		log.error(ex.getMessage());
			MessageService.error("Failed Saving UserWatchListStock .Try Again Later!");
			return null;
		}
	}
	...
	public void cancel()
	{
	    RequestContext.getCurrentInstance().closeDialog("createUserWatchListStock");
		
	}
	public UserWatchListStock saveUserWatchListStock(Session session){
	
	   this.userWatchListStock= userWatchListStockDataSource.create(this.userWatchListStock,session);
