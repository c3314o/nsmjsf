...
companyDataSource = new CompanyDataSource();
	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.latestPrice=latestPriceDataSource.get(editId);
			  ...
			  this.selectedCompanyWrapper=CompanyAdapter.wrap(latestPrice.getCompany());
	...
	public void setLatestPriceDataSource(LatestPriceDataSource latestPriceDataSource) {
...
public List<Company> getCompanyList() {
	...
	public LatestPrice saveLatestPrice(Session session){
	   ...
	   this.latestPrice= latestPriceDataSource.create(this.latestPrice,session);
