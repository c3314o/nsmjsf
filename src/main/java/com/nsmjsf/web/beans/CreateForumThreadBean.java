...
postDataSource = new PostDataSource();
	...
	public void setForumThreadDataSource(ForumThreadDataSource forumThreadDataSource) {
...
public List<Post> getPostList() {
	...
	public ForumThread saveForumThread(Session session){
	   ...
	   this.forumThread= forumThreadDataSource.create(this.forumThread,session);
