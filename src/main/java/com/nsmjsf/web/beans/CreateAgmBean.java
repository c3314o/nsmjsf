	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.agm=agmDataSource.get(editId);
			  ...
			  this.selectedFiscalYearWrapper=FiscalYearAdapter.wrap(agm.getFiscalYear());
	
			
			
			  
			  this.selectedAnnouncementWrapper=AnnouncementAdapter.wrap(agm.getAnnouncement());
