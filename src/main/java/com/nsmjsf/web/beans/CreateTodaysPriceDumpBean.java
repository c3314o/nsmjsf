...
public class CreateTodaysPriceDumpBean implements Serializable {
	...
	public void setTodaysPriceDumpDataSource(
	...
	public TodaysPriceDump saveTodaysPriceDump() {
		try {
			...
			MessageService
					.error("Failed Saving TodaysPriceDump .Try Again Later!");
			return null;
		}
	}
	...
	public void cancel() {
		RequestContext.getCurrentInstance()
				.closeDialog("createTodaysPriceDump");

	}

	public TodaysPriceDump saveTodaysPriceDump(Session session) {

		this.todaysPriceDump = todaysPriceDumpDataSource.create(
				this.todaysPriceDump, session);
