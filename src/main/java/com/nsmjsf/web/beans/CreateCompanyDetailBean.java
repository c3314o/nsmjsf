...
postDataSource = new PostDataSource();
	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.companyDetail=companyDetailDataSource.get(editId);
			  ...
			  this.selectedPostWrapper=PostAdapter.wrap(companyDetail.getPost());
	...
	public void setCompanyDetailDataSource(CompanyDetailDataSource companyDetailDataSource) {
...
public List<Post> getPostList() {
	...
	public CompanyDetail saveCompanyDetail() {
		...
		log.error(ex.getMessage());
			MessageService.error("Failed Saving CompanyDetail .Try Again Later!");
			return null;
		}
	}
	...
	public CompanyDetail saveCompanyDetail(Session session){
	   ...
	   this.companyDetail= companyDetailDataSource.create(this.companyDetail,session);
