...
public class CreateCompanyBranchBean implements Serializable {
	...
	public void setCompanyBranchDataSource(
	...
	public CompanyBranch saveCompanyBranch() {
		try {
			...
			MessageService
					.error("Failed Saving CompanyBranch .Try Again Later!");
			return null;
		}
	}
	...
	public CompanyBranch saveCompanyBranch(Session session) {
		...
		this.companyBranch = companyBranchDataSource.create(this.companyBranch,
				session);
