...
public class CreateFloorsheetHeaderBean implements Serializable {
	...
	public void setFloorsheetHeaderDataSource(
	...
	public FloorsheetHeader saveFloorsheetHeader() {
		try {
			...
			MessageService
					.error("Failed Saving FloorsheetHeader .Try Again Later!");
			return null;
		}
	}
	...
	public void cancel() {
		RequestContext.getCurrentInstance().closeDialog(
				"createFloorsheetHeader");

	}

	public FloorsheetHeader saveFloorsheetHeader(Session session) {

		this.floorsheetHeader = floorsheetHeaderDataSource.create(
				this.floorsheetHeader, session);
