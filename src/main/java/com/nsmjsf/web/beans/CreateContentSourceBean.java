...
postDataSource = new PostDataSource();
	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.contentSource=contentSourceDataSource.get(editId);
			  ...
			  this.selectedPostWrapper=PostAdapter.wrap(contentSource.getPost());
	...
	public void setContentSourceDataSource(ContentSourceDataSource contentSourceDataSource) {
...
public List<Post> getPostList() {
	...
	public ContentSource saveContentSource() {
		...
		log.error(ex.getMessage());
			MessageService.error("Failed Saving ContentSource .Try Again Later!");
			return null;
		}
	}
	...
	public ContentSource saveContentSource(Session session){
	   ...
	   this.contentSource= contentSourceDataSource.create(this.contentSource,session);
