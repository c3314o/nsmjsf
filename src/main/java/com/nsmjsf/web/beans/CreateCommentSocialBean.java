...
commentDataSource = new CommentDataSource();
		...
		commentWrapperList = CommentAdapter
				.wrapAll(commentList);
...
userDataSource = new UserDataSource();
	...
	private void init()
	{
		...
		if(this.editMode)
		{
			this.commentSocial=commentSocialDataSource.get(editId);
			  ...
			  this.selectedCommentWrapper=CommentAdapter.wrap(commentSocial.getComment());
	
			
			
			  
			  this.selectedUserWrapper=UserAdapter.wrap(commentSocial.getUser());
	...
	public void setCommentSocialDataSource(CommentSocialDataSource commentSocialDataSource) {
...
public List<Comment> getCommentList() {
	...
	public void setCommentDataSource(
	...
	public void setCommentWrapperList(
	...
	public void setSelectedCommentWrapper(
			CommentWrapper selectedCommentWrapper) {
...
public List<User> getUserList() {
	...
	public CommentSocial saveCommentSocial() {
		...
		log.error(ex.getMessage());
			MessageService.error("Failed Saving CommentSocial .Try Again Later!");
			return null;
		}
	}
	...
	public CommentSocial saveCommentSocial(Session session){
	   ...
	   this.commentSocial= commentSocialDataSource.create(this.commentSocial,session);
