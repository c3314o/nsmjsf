...
private static final Log log = LogFactory
	...
	public void setCurrencyTypeDataSource(CurrencyTypeDataSource currencyTypeDataSource) {
	...
	public CurrencyType saveCurrencyType() {
		...
		log.error(ex.getMessage());
			MessageService.error("Failed Saving CurrencyType .Try Again Later!");
			return null;
		}
	}
	...
	public CurrencyType saveCurrencyType(Session session){
	   ...
	   this.currencyType= currencyTypeDataSource.create(this.currencyType,session);
