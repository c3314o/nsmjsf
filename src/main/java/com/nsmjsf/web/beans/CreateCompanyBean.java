...
public class CreateCompanyBean implements Serializable {
	...
	public CreateCompanyBean() {
		...
		sectorWrapperList = SectorAdapter.wrapAll(sectorList);
	...
	private void init() {
		...
		if (this.editMode) {
			...
			this.selectedSectorWrapper = SectorAdapter
					.wrap(company.getSector());

			this.selectedPostWrapper = PostAdapter.wrap(company.getPost());

			this.selectedCompanyDetailWrapper = CompanyDetailAdapter
					.wrap(company.getCompanyDetail());
	...
	public void setSectorWrapperList(List<SectorWrapper> sectorWrapperList) {
	...
	public void setSelectedSectorWrapper(SectorWrapper selectedSectorWrapper) {
	...
	public Company saveCompany() {
		try {
			...
			CompanyDetail companyDetail = selectedCompanyDetailWrapper
					.getCompanyDetail();
