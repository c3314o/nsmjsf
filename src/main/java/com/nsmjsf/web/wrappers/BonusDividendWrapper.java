...
private static final Log log = LogFactory
	...
	public int hashCode() {
		int hash = 7;
		hash = 83 * hash + Objects.hashCode(this.bonusDividend.getBonusDividendId());
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!Objects.equals(this.bonusDividend.getBonusDividendId(), other.getBonusDividend().getBonusDividendId()))
			return false;
		return true;
	}
