...
public class AuditStatusWrapper {
	...
	private static final Log log = LogFactory.getLog(AuditStatusWrapper.class);
	...
	public int hashCode() {
		int hash = 7;
		hash = 83 * hash
				+ Objects.hashCode(this.auditStatus.getAuditStatusId());
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!Objects.equals(this.auditStatus.getAuditStatusId(), other
