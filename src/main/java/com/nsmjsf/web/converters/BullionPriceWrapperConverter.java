...
public class BullionPriceWrapperConverter implements Converter {
	private static final Log log = LogFactory
			.getLog(BullionPriceWrapperConverter.class);

	@Override
	public Object getAsObject(FacesContext fc, UIComponent arg1, String value) {
		if (value != null && value.trim().length() > 0) {
			BullionPriceDataSource bullionPriceDataSource = new BullionPriceDataSource();
			BullionPrice bullionPrice = bullionPriceDataSource.get(Integer
					.parseInt(value));
			BullionPriceWrapper bullionPriceWrapper = BullionPriceAdapter
					.wrap(bullionPrice);
	...
	public String getAsString(FacesContext fc, UIComponent arg1, Object object) {
		if (object != null) {
			return String.valueOf(((BullionPriceWrapper) object)
