...
public class BonusDividendWrapperConverter implements Converter {
	private static final Log log = LogFactory
			.getLog(BonusDividendWrapperConverter.class);

	@Override
	public Object getAsObject(FacesContext fc, UIComponent arg1, String value) {
		if (value != null && value.trim().length() > 0) {
			BonusDividendDataSource bonusDividendDataSource = new BonusDividendDataSource();
			BonusDividend bonusDividend = bonusDividendDataSource.get(Integer
					.parseInt(value));
			BonusDividendWrapper bonusDividendWrapper = BonusDividendAdapter
					.wrap(bonusDividend);
	...
	public String getAsString(FacesContext fc, UIComponent arg1, Object object) {
		if (object != null) {
			return String.valueOf(((BonusDividendWrapper) object)
