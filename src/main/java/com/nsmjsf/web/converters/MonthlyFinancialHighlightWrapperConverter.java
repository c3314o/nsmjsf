...
public class MonthlyFinancialHighlightWrapperConverter implements Converter {
	private static final Log log = LogFactory
			.getLog(MonthlyFinancialHighlightWrapperConverter.class);
	...
	public Object getAsObject(FacesContext fc, UIComponent arg1, String value) {
		if (value != null && value.trim().length() > 0) {
			...
			MonthlyFinancialHighlight monthlyFinancialHighlight = monthlyFinancialHighlightDataSource
					.get(Integer.parseInt(value));
			MonthlyFinancialHighlightWrapper monthlyFinancialHighlightWrapper = MonthlyFinancialHighlightAdapter
					.wrap(monthlyFinancialHighlight);
	...
	public String getAsString(FacesContext fc, UIComponent arg1, Object object) {
		if (object != null) {
			return String.valueOf(((MonthlyFinancialHighlightWrapper) object)
