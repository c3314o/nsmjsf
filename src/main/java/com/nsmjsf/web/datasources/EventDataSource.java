...
public class EventDataSource extends TDataSource<Event> {
	...
	@Override
	public Event create(Event record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Event> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public Event get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Event> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Event record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Event update(Event record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Event getByPost(int postId) {
		// TODO Auto-generated method stub
