...
public class NotificationDataSource extends TDataSource<Notification> {
	...
	@Override
	public Notification create(Notification record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Notification record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Notification update(Notification record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Notification create(Notification record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Notification get(int id, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Notification record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Notification update(Notification record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Notification getByPost(int postId) {
		// TODO Auto-generated method stub
