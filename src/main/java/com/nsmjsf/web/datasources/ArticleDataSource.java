...
public class ArticleDataSource extends TDataSource<Article>{
	...
	@Override
	public Article create(Article record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Article> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Article record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}
	...
	@Override
	public Article get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Article> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Article record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Article update(Article record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Article getByPost(int postId) {
		// TODO Auto-generated method stub
