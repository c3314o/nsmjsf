...
public class UserInfoDataSource extends TDataSource<UserInfo>{

	public UserInfoDataSource()
	{
		super();
		this.setTableName("UserInfo");
		this.setPrimaryKey("user_info_id");
	}

	
	@Override
	public List<UserInfo> getByUser(int userId) {
	...
	@Override
	public UserInfo create(UserInfo record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<UserInfo> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public UserInfo create(UserInfo record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public UserInfo get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<UserInfo> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(UserInfo record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public UserInfo update(UserInfo record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public UserInfo getByPost(int postId) {
		// TODO Auto-generated method stub
