...
public class AgmDataSource extends TDataSource<Agm> {

	public AgmDataSource() {
		super();
		this.setTableName("Agm");
		this.setPrimaryKey("agm_id");
	}

	@Override
	public List<Agm> getByUser(int userId) {
	...
	@Override
	public Agm create(Agm record, Session session) {
		// TODO Auto-generated method stub
		return super.create(record, session);
	}

	@Override
	public List<Agm> getAll() {
		// TODO Auto-generated method stub
		return super.getAll();
	}

	@Override
	public Agm get(int id) {
		// TODO Auto-generated method stub
		return super.get(id);
	}

	@Override
	public List<Agm> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Agm record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Agm update(Agm record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Agm create(Agm record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Agm get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Agm> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Agm record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Agm update(Agm record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Agm getByPost(int postId) {
		// TODO Auto-generated method stub
