...
public class PostDataSource extends TDataSource<Post>{
	...
	@Override
	public Post create(Post record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Post> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Post record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Post update(Post record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Post create(Post record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Post get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Post> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Post record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Post update(Post record, Session session) {
		// TODO Auto-generated method stub
