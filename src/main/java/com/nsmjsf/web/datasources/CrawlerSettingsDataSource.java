...
public class CrawlerSettingsDataSource extends TDataSource<CrawlerSettings>{
	...
	@Override
	public CrawlerSettings create(CrawlerSettings record, Session session) {
		// TODO Auto-generated method stub
		return super.create(record, session);
	}

	@Override
	public List<CrawlerSettings> getAll() {
		// TODO Auto-generated method stub
		return super.getAll();
	}

	@Override
	public CrawlerSettings get(int id) {
		// TODO Auto-generated method stub
		return super.get(id);
	}
	...
	@Override
	public void delete(CrawlerSettings record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public CrawlerSettings update(CrawlerSettings record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public CrawlerSettings create(CrawlerSettings record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public CrawlerSettings get(int id, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(CrawlerSettings record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public CrawlerSettings update(CrawlerSettings record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public CrawlerSettings getByPost(int postId) {
		// TODO Auto-generated method stub
