...
public class CommentDataSource extends TDataSource<Comment>{
	...
	@Override
	public Comment create(Comment record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public Comment get(int id, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Comment record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Comment update(Comment record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Comment getByPost(int postId) {
		// TODO Auto-generated method stub
