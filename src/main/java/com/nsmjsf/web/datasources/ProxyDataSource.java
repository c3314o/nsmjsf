...
public class ProxyDataSource extends TDataSource<Proxy>{

	public ProxyDataSource()
	{
		super();
		this.setTableName("Proxy");
		this.setPrimaryKey("proxy_id");
	}

	
	@Override
	public List<Proxy> getByUser(int userId) {
	...
	@Override
	public Proxy create(Proxy record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Proxy> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Proxy record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Proxy update(Proxy record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Proxy create(Proxy record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Proxy get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Proxy> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Proxy record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Proxy update(Proxy record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Proxy getByPost(int postId) {
		// TODO Auto-generated method stub
