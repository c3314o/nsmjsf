...
public class InterviewDataSource extends TDataSource<Interview>{

	public InterviewDataSource()
	{
		super();
		this.setTableName("Interview");
		this.setPrimaryKey("interview_id");
	}

	
	@Override
	public List<Interview> getByUser(int userId) {
	...
	@Override
	public Interview create(Interview record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Interview> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Interview record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Interview update(Interview record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Interview create(Interview record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Interview get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Interview> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Interview record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Interview update(Interview record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Interview getByPost(int postId) {
		// TODO Auto-generated method stub
