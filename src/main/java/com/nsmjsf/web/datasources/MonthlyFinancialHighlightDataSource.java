...
public class MonthlyFinancialHighlightDataSource extends TDataSource<MonthlyFinancialHighlight>{
	...
	@Override
	public List<MonthlyFinancialHighlight> getAll() {
		// TODO Auto-generated method stub
		return super.getAll();
	}

	@Override
	public MonthlyFinancialHighlight get(int id) {
		// TODO Auto-generated method stub
		return super.get(id);
	}
	...
	@Override
	public void delete(MonthlyFinancialHighlight record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}
	...
	@Override
	public MonthlyFinancialHighlight get(int id, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(MonthlyFinancialHighlight record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public MonthlyFinancialHighlight getByPost(int postId) {
		// TODO Auto-generated method stub
