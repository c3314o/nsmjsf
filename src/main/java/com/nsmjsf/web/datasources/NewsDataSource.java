...
public class NewsDataSource extends TDataSource<News> {
	...
	@Override
	public List<News> getByUser(int userId) {
	...
	@Override
	public News create(News record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<News> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public News update(News record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public News create(News record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public News get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<News> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(News record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public News update(News record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public News getByPost(int postId) {
		// TODO Auto-generated method stub
