...
public class UserDataSource extends TDataSource<User> {
	...
	@Override
	public User create(User record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<User> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public User get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<User> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(User record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public User update(User record, Session session) {
		// TODO Auto-generated method stub
