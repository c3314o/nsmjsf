...
public class UserStockDataSource extends TDataSource<UserStock>{

	public UserStockDataSource()
	{
		super();
		this.setTableName("UserStock");
		this.setPrimaryKey("user_stock_id");
	}

	
	@Override
	public List<UserStock> getByUser(int userId) {
	...
	@Override
	public UserStock create(UserStock record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public UserStock get(int id) {
		// TODO Auto-generated method stub
		return super.get(id);
	}

	@Override
	public List<UserStock> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public UserStock update(UserStock record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public UserStock create(UserStock record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public UserStock get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<UserStock> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(UserStock record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public UserStock update(UserStock record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public UserStock getByPost(int postId) {
		// TODO Auto-generated method stub
