...
public class PostImageDataSource extends TDataSource<PostImage>{

	public PostImageDataSource()
	{
		super();
		this.setTableName("PostImage");
		this.setPrimaryKey("post_image_id");
	}

	
	@Override
	public List<PostImage> getByUser(int userId) {
	...
	@Override
	public PostImage create(PostImage record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<PostImage> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(PostImage record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public PostImage update(PostImage record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public PostImage create(PostImage record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public PostImage get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<PostImage> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(PostImage record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public PostImage update(PostImage record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public PostImage getByPost(int postId) {
		// TODO Auto-generated method stub
