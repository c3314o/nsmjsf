...
public class ForumThreadDataSource extends TDataSource<ForumThread>{

	public ForumThreadDataSource()
	{
		super();
		this.setTableName("ForumThread");
		this.setPrimaryKey("forum_thread_id");
	}
	...
	@Override
	public ForumThread create(ForumThread record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<ForumThread> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(ForumThread record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public ForumThread update(ForumThread record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public ForumThread create(ForumThread record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public ForumThread get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<ForumThread> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(ForumThread record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public ForumThread update(ForumThread record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public ForumThread getByPost(int postId) {
		// TODO Auto-generated method stub
