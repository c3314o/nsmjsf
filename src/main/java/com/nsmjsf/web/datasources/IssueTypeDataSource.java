...
public class IssueTypeDataSource extends TDataSource<IssueType>{

	public IssueTypeDataSource()
	{
		super();
		this.setTableName("IssueType");
		this.setPrimaryKey("issue_type_id");
	}

	
	@Override
	public List<IssueType> getByUser(int userId) {
	...
	@Override
	public IssueType create(IssueType record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<IssueType> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(IssueType record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public IssueType update(IssueType record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public IssueType create(IssueType record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public IssueType get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<IssueType> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(IssueType record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public IssueType update(IssueType record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public IssueType getByPost(int postId) {
		// TODO Auto-generated method stub
