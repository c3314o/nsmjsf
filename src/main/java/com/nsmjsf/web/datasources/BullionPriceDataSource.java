...
public class BullionPriceDataSource extends TDataSource<BullionPrice> {
	...
	@Override
	public BullionPrice create(BullionPrice record, Session session) {
		// TODO Auto-generated method stub
		return super.create(record, session);
	}

	@Override
	public List<BullionPrice> getAll() {
		// TODO Auto-generated method stub
		return super.getAll();
	}

	@Override
	public BullionPrice get(int id) {
		// TODO Auto-generated method stub
		return super.get(id);
	}
	...
	@Override
	public void delete(BullionPrice record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public BullionPrice update(BullionPrice record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public BullionPrice create(BullionPrice record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public BullionPrice get(int id, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(BullionPrice record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public BullionPrice update(BullionPrice record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public BullionPrice getByPost(int postId) {
		// TODO Auto-generated method stub
