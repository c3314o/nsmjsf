...
public class SectorDataSource extends TDataSource<Sector>{

	public SectorDataSource()
	{
		super();
		this.setTableName("Sector");
		this.setPrimaryKey("sector_id");
	}

	
	@Override
	public List<Sector> getByUser(int userId) {
	...
	@Override
	public Sector create(Sector record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Sector> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Sector record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Sector update(Sector record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Sector create(Sector record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Sector get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Sector> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Sector record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Sector update(Sector record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Sector getByPost(int postId) {
		// TODO Auto-generated method stub
