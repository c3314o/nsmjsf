...
public class UserTypeDataSource extends TDataSource<UserType>{

	public UserTypeDataSource()
	{
		super();
	...
	@Override
	public List<UserType> getByUser(int userId) {
	...
	@Override
	public UserType create(UserType record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<UserType> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(UserType record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}
	...
	@Override
	public UserType get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<UserType> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(UserType record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public UserType update(UserType record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public UserType getByPost(int postId) {
		// TODO Auto-generated method stub
