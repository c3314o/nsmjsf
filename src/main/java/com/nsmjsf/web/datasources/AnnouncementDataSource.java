...
public class AnnouncementDataSource extends TDataSource<Announcement>{

	public AnnouncementDataSource()
	{
		super();
	...
	@Override
	public List<Announcement> getByUser(int userId) {
	...
	@Override
	public Announcement create(Announcement record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Announcement> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Announcement record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Announcement update(Announcement record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Announcement create(Announcement record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Announcement get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Announcement> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Announcement record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Announcement update(Announcement record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Announcement getByPost(int postId) {
		// TODO Auto-generated method stub
