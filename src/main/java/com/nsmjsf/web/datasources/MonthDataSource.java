...
public class MonthDataSource extends TDataSource<Month>{

	public MonthDataSource()
	{
		super();
		this.setTableName("Month");
		this.setPrimaryKey("month_id");
	}

	
	@Override
	public List<Month> getByUser(int userId) {
	...
	@Override
	public Month create(Month record, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Month> getWhere(HashMap<String, Object> clauses) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Month record) {
		// TODO Auto-generated method stub
		super.delete(record);
	}

	@Override
	public Month update(Month record) {
		// TODO Auto-generated method stub
		return super.update(record);
	}

	@Override
	public Month create(Month record) {
		// TODO Auto-generated method stub
		return super.create(record);
	}

	@Override
	public Month get(int id, Session session) {
		// TODO Auto-generated method stub
		return super.get(id, session);
	}

	@Override
	public List<Month> getWhere(HashMap<String, Object> clauses, Session session) {
		// TODO Auto-generated method stub
	...
	@Override
	public void delete(Month record, Session session) {
		// TODO Auto-generated method stub
		super.delete(record, session);
	}

	@Override
	public Month update(Month record, Session session) {
		// TODO Auto-generated method stub
		return super.update(record, session);
	}

	@Override
	public Month getByPost(int postId) {
		// TODO Auto-generated method stub
