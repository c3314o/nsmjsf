...
public class MonthlyFinancialHighlightAdapter {
	...
	public static List<MonthlyFinancialHighlightWrapper> wrapAll(
		...
		for (MonthlyFinancialHighlight monthlyFinancialHighlight : monthlyFinancialHighlightList) {
			...
			monthlyFinancialHighlightWrapper
					.setMonthlyFinancialHighlight(monthlyFinancialHighlight);
			monthlyFinancialHighlightWrapperList
					.add(monthlyFinancialHighlightWrapper);
		}
		return monthlyFinancialHighlightWrapperList;

	}

	public static MonthlyFinancialHighlightWrapper wrap(
